...
/*
                ...
                players[0].setGamesPlayed (3);
                players[0].setGamesWon ( 3 );
                players[0].SetWinPercentage ((float)players[0].getGamesWon (), (float)players[0].getGamesPlayed ());


                players[1] = new NimPlayer ();
                players[1].setPlayer ( "jadams","Adams","John");
                players[1].setGamesPlayed (7);
                players[1].setGamesWon ( 2 );
                players[1].SetWinPercentage ((float)players[1].getGamesWon (), (float)players[1].getGamesPlayed ());

                players[2] = new NimPlayer ();
                players[2].setPlayer ( "tom","Jefferson","Thomas" );
                players[2].setGamesPlayed (4);
                players[2].setGamesWon ( 3 );
                players[2].setWinPercentage ();

                players[3] = new NimPlayer ();
                players[3].setPlayer ( "jmadison","Madison","James");
                players[3].setGamesPlayed (4);
                players[3].setGamesWon ( 3 );
                players[3].SetWinPercentage ((float)players[1].getGamesWon (), (float)players[1].getGamesPlayed ());

                players[4] = new NimPlayer ();
                players[4].setPlayer ( "jmonroe","Monroe","James"  );
                players[4].setGamesPlayed (4);
                players[4].setGamesWon ( 3 );
                players[4].SetWinPercentage ((float)players[1].getGamesWon (), (float)players[1].getGamesPlayed ());

                players[5] = new NimPlayer ();
                players[5].setPlayer ( "bob","boobsy","leo" );
                players[5].setGamesPlayed (13);
                players[5].setGamesWon ( 3 );
                players[5].SetWinPercentage ((float)players[1].getGamesWon (), (float)players[1].getGamesPlayed ());

                players[6] = new NimPlayer ();
                players[6].setPlayer ( "julz","Julio","Hulio");
                players[6].setGamesPlayed (12);
                players[6].setGamesWon ( 3 );
                players[6].SetWinPercentage ((float)players[1].getGamesWon (), (float)players[1].getGamesPlayed ());

                players[7] = new NimPlayer ();
                players[7].setPlayer ( "tim","Timothy","Thomas" );
                players[7].setGamesPlayed (7);
                players[7].setGamesWon ( 1 );
                players[7].SetWinPercentage ((float)players[1].getGamesWon (), (float)players[1].getGamesPlayed ());
...
*/
    ...
    static void playerRankFormatting (NimPlayer[] players, int index) {
        ...
        String playerPercentageInner = String.format ( "%1.0f%%", players[index].getWinPercentage () );
        String playerPercentageOuter = String.format ( "%-4s", playerPercentageInner );
        System.out.print ( playerPercentageOuter );
        System.out.print ( " | " );
        String playerGamesPlayedInner = String.format ( "%02d", players[index].getGamesPlayed () );
