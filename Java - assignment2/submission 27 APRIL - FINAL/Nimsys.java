...
*/
        ...
        for (int k = 0; ; k++) {
            ...
            if (function.equalsIgnoreCase ( addPlayer )) {
                ...
                if (userinput.isEmpty ()) {
                    ...
                    int checkPlayer = playerChecker ( players, username, playerCounter );
    ...
    static int addPlayer (NimPlayer[] players, String username, String lastname, String firstname, int playerCounter) {
        if (playerCounter == 0) {
            ...
            int result = playerChecker ( players, username, playerCounter );
            if (result == 1) {
    ...
    static int playerChecker(NimPlayer[] players, String username, int playerCounter) {
        int result = 0;
    ...
    static void startGameFunction(NimPlayer[] players, Scanner keyboard, int playerCounter, String username1, String username2, int initialStones, int upperBound) {
        ...
        int checkPlayer1 = playerChecker ( players, username1, playerCounter );
        if (checkPlayer1 == 1) {
            player_check++;
        ...
        int checkPlayer2 = playerChecker ( players, username2, playerCounter );
        if (checkPlayer2 == 1) {
            player_check++;
